...
ogcEditKey := myGui.Add("text", "x395 y190 w200 h20", "Key:")
ogcEditIV := myGui.Add("Edit", "x420 y190 w200 h20 vKey", "")
myGui.SetFont("s10", "Courier New")
ogcEditResult := myGui.Add("Edit", "xm w600 r10 vResult +ReadOnly")
myGui.Title := "AHK RC4 Encryption Tool " Chr(169) " 2020-2023 - ALBANESE Reasearch Lab"
myGui.Show()
return
